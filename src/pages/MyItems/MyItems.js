...
const MyItems = () => {
    ...
    useEffect(() => {
        ...
        const getMyItems = async () => {
            ...
            const url = `https://cryptic-shore-03299.herokuapp.com/service?email=${email}`;
            try {
        ...
        <div className='my-5 min-vh-100'>
            <div className='container'>
                ...
                <div className='mb-4 text-center' >
                    <Link to={'/update'} className='btn btn-danger'>View All bikes</Link>
                ...
                <div className="row text-white">
                    <div className="col-12">
                        <Table striped bordered hover responsive variant="dark">
                            ...
                            <tbody>
                                {
                                    bikes.filter(car => car.email === user.email)?.map(car => {
                                        return (
