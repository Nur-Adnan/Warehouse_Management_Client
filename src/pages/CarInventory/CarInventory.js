...
const CarInventory = () => {
    ...
    useEffect(() => {
        const url = `https://cryptic-shore-03299.herokuapp.com/service/${carId}`;
        fetch(url)
            .then(res => res.json())
    ...
    const handleCarDeliveredQuantity = () => {
        ...
        if (quantity !== 0) {
            ...
            const url = `https://cryptic-shore-03299.herokuapp.com/service/${_id}`;
            fetch(url, {
                method: 'PUT',
                headers: {
                        ...
                        <div className="text-white bg-dark">
                            ...
                            <div className="p-4">
                                ...
                                <div className='d-md-flex  justify-content-md-around text-center my-4'>
                                    ...
                                    <p className='card-text'>Supplier: <strong className='text-danger'>{car.supplierName}</strong></p>
                                </div>
